"""Worst production month tool (lowest yield)."""
...
ORDER BY yield_percentage ASC, production_year, production_month;
"""
...
def run() -> dict:
    """Return the production month with the lowest yield percentage."""
